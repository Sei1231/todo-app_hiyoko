...
@section('content')
    ...
    <script>
    document.querySelectorAll('.genre-buttons .btn').forEach(function(button) {
        button.addEventListener('click', function () {
            document.getElementById('genre').value = this.textContent.trim();

            // スタイルをリセットして選択を可視化
            document.querySelectorAll('.genre-buttons .btn').forEach(btn => {
